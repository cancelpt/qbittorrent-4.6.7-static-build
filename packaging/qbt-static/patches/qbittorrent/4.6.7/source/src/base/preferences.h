...
public:
    ...
    int sessionAlertQueueSize() const;
    bool isExperimentalWebUIMemoryProbeEnabled() const;
    int experimentalWebUIMemoryProbeIntervalMs() const;
    QString experimentalWebUIMemoryProbeOutputPath() const;
    bool isExperimentalDeferredTorrentFilePathsEnabled() const;
    bool isExperimentalDeferredTorrentFileStateEnabled() const;
    bool isExperimentalSparseTorrentRenamedFilesEnabled() const;
    bool isExperimentalShareTorrentInfoNativeInfoEnabled() const;
    bool isExperimentalOmitWebUISavePathEnabled() const;
    bool isExperimentalDisableWebUIInitialFullResponseCacheEnabled() const;
    bool isExperimentalStatelessWebUIMaindataEnabled() const;
    bool isExperimentalOmitWebUIMaindataTorrentsEnabled() const;
    bool isExperimentalOmitWebUIMaindataTorrentPathFieldsEnabled() const;
    bool isExperimentalOmitWebUIMaindataTorrentMagnetUriEnabled() const;
    bool isExperimentalOmitWebUIMaindataTorrentIdentityFieldsEnabled() const;
    bool isExperimentalOmitWebUIMaindataTorrentDescriptiveFieldsEnabled() const;
    bool isExperimentalOmitWebUIMaindataTorrentNumericFieldsEnabled() const;
    bool isExperimentalMinimalWebUIMaindataTorrentObjectEnabled() const;
    bool isExperimentalCompactWebUIMaindataTorrentRowsEnabled() const;
    bool isExperimentalDirectWebUIStatelessMaindataResponseEnabled() const;
    bool isExperimentalDirectCompactWebUIInitialFullResponseEnabled() const;
    bool isExperimentalDirectCompactWebUIMaindataSnapshotEnabled() const;
    bool isExperimentalCompactWebUIMaindataStringPoolEnabled() const;
    bool isExperimentalCompactWebUIMaindataDescriptiveSidecarEnabled() const;
    bool isExperimentalCompactWebUIMaindataDescriptiveSubgroupsEnabled() const;
    bool isExperimentalCompactWebUIMaindataDescriptiveLifecycleOnDemandEnabled() const;
    bool isExperimentalCompactWebUIMaindataDescriptiveNumericOnDemandEnabled() const;
    bool isExperimentalReleaseIdleWebUIMaindataStateEnabled() const;
    bool isExperimentalTrimAllocatorAfterIdleWebUIMaindataReleaseEnabled() const;
    int experimentalWebUINonIdleTrimMaxActiveSyncSessions() const;
    bool isExperimentalDropAtpTorrentInfoAfterMetadataReadyEnabled() const;
    bool isExperimentalOmitWebUIContentPathEnabled() const;
    bool isExperimentalTouchWebUIContentPathNoStoreEnabled() const;
