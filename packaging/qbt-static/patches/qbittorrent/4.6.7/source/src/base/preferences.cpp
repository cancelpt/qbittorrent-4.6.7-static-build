...
int Preferences::sessionAlertQueueSize() const
{
    const int queueSize = value<int>(u"BitTorrent/SessionAlertQueueSize"_s, 10'000);
    return ((queueSize >= 100) ? queueSize : 100);
}

bool Preferences::isExperimentalWebUIMemoryProbeEnabled() const
{
    return value(u"BitTorrent/ExperimentalWebUIMemoryProbeEnabled"_s, false);
}

int Preferences::experimentalWebUIMemoryProbeIntervalMs() const
{
    const int intervalMs = value<int>(u"BitTorrent/ExperimentalWebUIMemoryProbeIntervalMs"_s, 5000);
    return ((intervalMs >= 200) ? intervalMs : 200);
}

QString Preferences::experimentalWebUIMemoryProbeOutputPath() const
{
    return value(u"BitTorrent/ExperimentalWebUIMemoryProbeOutputPath"_s, QString {}).trimmed();
}

bool Preferences::isExperimentalDeferredTorrentFilePathsEnabled() const
{
    return value(u"BitTorrent/ExperimentalDeferredTorrentFilePaths"_s, true);
}

bool Preferences::isExperimentalDeferredTorrentFileStateEnabled() const
{
    return value(u"BitTorrent/ExperimentalDeferredTorrentFileState"_s, false);
}

bool Preferences::isExperimentalSparseTorrentRenamedFilesEnabled() const
{
    return value(u"BitTorrent/ExperimentalSparseTorrentRenamedFiles"_s, false);
}

bool Preferences::isExperimentalShareTorrentInfoNativeInfoEnabled() const
{
    Q_UNUSED(value<bool>(u"BitTorrent/ExperimentalShareTorrentInfoNativeInfo"_s, false));
    // This experiment showed no reliable memory win in practice.
    // Keep it hard-disabled so stale configs cannot re-enable it.
    return false;
}

bool Preferences::isExperimentalOmitWebUISavePathEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUISavePath"_s, false);
}

bool Preferences::isExperimentalDisableWebUIInitialFullResponseCacheEnabled() const
{
    return value(u"BitTorrent/ExperimentalDisableWebUIInitialFullResponseCache"_s, false);
}

bool Preferences::isExperimentalStatelessWebUIMaindataEnabled() const
{
    return value(u"BitTorrent/ExperimentalStatelessWebUIMaindata"_s, false);
}

bool Preferences::isExperimentalOmitWebUIMaindataTorrentsEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIMaindataTorrents"_s, false);
}

bool Preferences::isExperimentalOmitWebUIMaindataTorrentPathFieldsEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIMaindataTorrentPathFields"_s, false);
}

bool Preferences::isExperimentalOmitWebUIMaindataTorrentMagnetUriEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIMaindataTorrentMagnetUri"_s, false);
}

bool Preferences::isExperimentalOmitWebUIMaindataTorrentIdentityFieldsEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIMaindataTorrentIdentityFields"_s, false);
}

bool Preferences::isExperimentalOmitWebUIMaindataTorrentDescriptiveFieldsEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIMaindataTorrentDescriptiveFields"_s, false);
}

bool Preferences::isExperimentalOmitWebUIMaindataTorrentNumericFieldsEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIMaindataTorrentNumericFields"_s, false);
}

bool Preferences::isExperimentalMinimalWebUIMaindataTorrentObjectEnabled() const
{
    return value(u"BitTorrent/ExperimentalMinimalWebUIMaindataTorrentObject"_s, false);
}

bool Preferences::isExperimentalCompactWebUIMaindataTorrentRowsEnabled() const
{
    return value(u"BitTorrent/ExperimentalCompactWebUIMaindataTorrentRows"_s, false);
}

bool Preferences::isExperimentalDirectWebUIStatelessMaindataResponseEnabled() const
{
    return value(u"BitTorrent/ExperimentalDirectWebUIStatelessMaindataResponse"_s, false);
}

bool Preferences::isExperimentalDirectCompactWebUIInitialFullResponseEnabled() const
{
    return value(u"BitTorrent/ExperimentalDirectCompactWebUIInitialFullResponse"_s, false);
}

bool Preferences::isExperimentalDirectCompactWebUIMaindataSnapshotEnabled() const
{
    return value(u"BitTorrent/ExperimentalDirectCompactWebUIMaindataSnapshot"_s, false);
}

bool Preferences::isExperimentalCompactWebUIMaindataStringPoolEnabled() const
{
    return value(u"BitTorrent/ExperimentalCompactWebUIMaindataStringPool"_s, false);
}

bool Preferences::isExperimentalCompactWebUIMaindataDescriptiveSidecarEnabled() const
{
    return value(u"BitTorrent/ExperimentalCompactWebUIMaindataDescriptiveSidecar"_s, false);
}

bool Preferences::isExperimentalCompactWebUIMaindataDescriptiveSubgroupsEnabled() const
{
    return value(u"BitTorrent/ExperimentalCompactWebUIMaindataDescriptiveSubgroups"_s, false);
}

bool Preferences::isExperimentalCompactWebUIMaindataDescriptiveLifecycleOnDemandEnabled() const
{
    return value(u"BitTorrent/ExperimentalCompactWebUIMaindataDescriptiveLifecycleOnDemand"_s, false);
}

bool Preferences::isExperimentalCompactWebUIMaindataDescriptiveNumericOnDemandEnabled() const
{
    return value(u"BitTorrent/ExperimentalCompactWebUIMaindataDescriptiveNumericOnDemand"_s, false);
}

bool Preferences::isExperimentalReleaseIdleWebUIMaindataStateEnabled() const
{
    return value(u"BitTorrent/ExperimentalReleaseIdleWebUIMaindataState"_s, false);
}

bool Preferences::isExperimentalTrimAllocatorAfterIdleWebUIMaindataReleaseEnabled() const
{
    return value(u"BitTorrent/ExperimentalTrimAllocatorAfterIdleWebUIMaindataRelease"_s, false);
}

int Preferences::experimentalWebUINonIdleTrimMaxActiveSyncSessions() const
{
    const int configured = value(u"BitTorrent/ExperimentalWebUINonIdleTrimMaxActiveSyncSessions"_s, 3);
    return (configured < 0) ? 0 : configured;
}

bool Preferences::isExperimentalDropAtpTorrentInfoAfterMetadataReadyEnabled() const
{
    Q_UNUSED(value<bool>(u"BitTorrent/ExperimentalDropAtpTorrentInfoAfterMetadataReady"_s, false));
    // This experiment breaks legacy .torrent persistence and restart recovery.
    // Keep the preference hard-disabled even if stale live configs still carry it.
    return false;
}

bool Preferences::isExperimentalOmitWebUIContentPathEnabled() const
{
    return value(u"BitTorrent/ExperimentalOmitWebUIContentPath"_s, false);
}

bool Preferences::isExperimentalTouchWebUIContentPathNoStoreEnabled() const
{
    return value(u"BitTorrent/ExperimentalTouchWebUIContentPathNoStore"_s, false);
}
