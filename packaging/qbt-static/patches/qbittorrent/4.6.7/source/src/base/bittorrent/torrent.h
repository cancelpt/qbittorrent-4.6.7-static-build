...
namespace BitTorrent
{
    ...
    struct ResidentMemberFamilyBytes
    {
        qint64 filePaths = 0;
        qint64 indexMap = 0;
        qint64 filePriorities = 0;
        qint64 completedFiles = 0;
        qint64 filesProgress = 0;
        qint64 piecesBitfield = 0;
        qint64 atpFilePriorities = 0;
        qint64 atpRenamedFiles = 0;
        qint64 atpTrackers = 0;
        qint64 atpTrackerTiers = 0;
        qint64 atpUrlSeeds = 0;
        qint64 atpHavePieces = 0;
        qint64 atpVerifiedPieces = 0;
        qint64 atpUnfinishedPieces = 0;
        qint64 atpSavePath = 0;
        qint64 persistentName = 0;
        qint64 persistentSavePath = 0;
        qint64 persistentDownloadPath = 0;
        qint64 persistentCategory = 0;
        qint64 trackerEntries = 0;
        qint64 urlSeeds = 0;
        qint64 nativeStatusCoreStrings = 0;
        qint64 nativeStatusPiecesBitfield = 0;
        qint64 torrentInfoMetadata = 0;
        qint64 torrentInfoMetadataAliased = 0;
        qint64 torrentInfoMetadataUnique = 0;
        qint64 atpTorrentInfoMetadata = 0;
        qint64 atpTorrentInfoMetadataAliased = 0;
        qint64 atpTorrentInfoMetadataUnique = 0;

        qint64 total() const
        {
            return (filePaths + indexMap + filePriorities + completedFiles + filesProgress);
        }

        qint64 extendedTotal() const
        {
            return (total() + piecesBitfield + atpFilePriorities + atpRenamedFiles + atpTrackers + atpTrackerTiers
                + atpUrlSeeds + atpHavePieces + atpVerifiedPieces + atpUnfinishedPieces + atpSavePath
                + persistentName + persistentSavePath + persistentDownloadPath + persistentCategory
                + trackerEntries + urlSeeds + nativeStatusCoreStrings + nativeStatusPiecesBitfield
                + torrentInfoMetadata + atpTorrentInfoMetadata);
        }
    };
    ...
    public:
        ...
        virtual ResidentMemberFamilyBytes residentMemberFamilyBytes() const = 0;
