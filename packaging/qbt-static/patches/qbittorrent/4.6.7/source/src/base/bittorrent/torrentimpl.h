...
namespace BitTorrent
{
    ...
    public:
        ...
        ResidentMemberFamilyBytes residentMemberFamilyBytes() const override;
    ...
    private:
        ...
        bool shouldDeferFilePaths() const;
        bool shouldDeferFileState() const;
        bool shouldUseSparseRenamedFiles() const;
        Path resolvedFilePath(int index) const;
        PathList resolvedFilePaths() const;
        int resolvedFileIndex(lt::file_index_t nativeIndex) const;
        QVector<DownloadPriority> resolvedFilePriorities() const;
        bool isCompletedFile(int index) const;
        QVector<std::int64_t> resolvedFilesProgress() const;
        void clearCachedFileState();
        void refreshResidentMemberFamilyBytes();
        void appendInitialFilePath(const Path &filePath);
        void clearCachedFilePaths();
        void updateCachedFilePath(int index, const Path &filePath);
        ...
        ResidentMemberFamilyBytes m_residentMemberFamilyBytes;
    };
}
